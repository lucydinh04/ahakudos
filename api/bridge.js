...
import { callGoogle, METHODS } from '../lib/bridge.js';
...
export async function handle(req, res, deps = {}) {
  ...
  try {
    ...
    if (!Object.prototype.hasOwnProperty.call(METHODS, b.method) || !Array.isArray(b.args) || b.args.length !== METHODS[b.method]) throw new HttpError(400, 'Thao tác không được cho phép.', 'METHOD_NOT_ALLOWED');
